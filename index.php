...
<html lang="en">
  ...
  <head>
    ...
    <title>Filipino Arts Gallery</title>
                    ...
                    <nav class="main-nav">
                        ...
                        <header class="text-black">
                            <div class="container px-4 text-center">
                                <h1 class="fw-bolder">FILIPINO ARTS GALLERY</h1>
                                <p class="lead">"Find the art in your heart. It is the conversion of imagination to reality."</p>
                            </div>
                        </header>
                                <br>
                                <br>
                    ...
                    <div class="left-content">
                        <div class="thumb">
                            <div class="inner-content">
                                ...
                                <br>
                                <br>
                                <h4>Fernando Amorsolo</h4>
                                <span>Known for his Illuminated Landscape Paintings</span>
                                <div class="main-border-button">
                                    
                                </div>
                            </div>
                            <img src="assets/images/amorsolo.jpg" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                                ...
                                <div class="right-first-image">
                                    <div class="thumb">
                                        <div class="inner-content">
                                                ...
                                                <br>
                                                <br>
                                            <h4>Guillermo Tolentino</h4>
                                        </div>
                                        <img src="assets/images/Tolentino.jpg">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="right-first-image">
                                    <div class="thumb">
                                        <div class="inner-content">
                                                ...
                                                <br>
                                                <br>
                                            <h4>Benedicto Cabrera</h4>
                                        </div>
                                        <img src="assets/images/cabrera.jpg">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="right-first-image">
                                    <div class="thumb">
                                        ...
                                        <img src="assets/images/Manansala.jpg">
                                    </div>
                                </div>
                            </div>
                        </div>
